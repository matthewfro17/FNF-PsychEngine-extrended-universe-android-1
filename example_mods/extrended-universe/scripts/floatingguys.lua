...
floaters = {'baggett', 'bambi-minion', 'bamblix', 'bamburg', 'cakebi', 'chocolabi-crazy', 'chocolabi', 'crusti', 'dembo', 'figumbi', 'fully-breakfast-pichi', 'nuggbi', 'yambi'}
exclude = {'baggett', 'bambi-minion', 'bamblix', 'bamburg', 'cakebi', 'chocolabi-crazy', 'chocolabi', 'crusti', 'dembo', 'figumbi', 'fully-breakfast-pichi', 'nuggbi', 'yambi'} --only apply the 3d notes
shitters = {}  
elapsedTime = 0
function onCreate()
  luaDebugMode = true
