...
floaters = {'krembi-window', 'krembi', 'stremblix', 'alert', 'running-pichi', 'code-pichi', 'calabazin', 'angry-calabazin', 'emma', 'angry-emma', 'alex', 'sunday', 'seumadruga', 'stremBSOD', 'stremblix-trolled', 'alert-trolled', 'calabazin-trolled', 'alex-trolled', 'sunday-trolled', 'seumadruga-trolled', 'nocallate', 'first-person-pichi'}
exclude = {'krembi-window', 'krembi', 'stremblix', 'alert', 'running-pichi', 'code-pichi', 'calabazin', 'angry-calabazin', 'emma', 'angry-emma', 'alex', 'sunday', 'seumadruga', 'stremBSOD', 'stremblix-trolled', 'alert-trolled', 'calabazin-trolled', 'alex-trolled', 'sunday-trolled', 'seumadruga-trolled', 'nocallate', 'first-person-pichi'} --only apply the 3d notes
shitters = {}  
elapsedTime = 0
function onCreate()
  luaDebugMode = true
